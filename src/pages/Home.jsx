      ...
      <header className="header">
        <div className="navbar">
          <div className="logo-container">
            <img
              src="https://t3.ftcdn.net/jpg/05/18/32/78/360_F_518327895_sEJ0spaygdutmQ25Jw38Wb1MWB4gnWvB.jpg"
              alt="Logo"
        ...
        <div className="header-image">
          <img
            src="https://img.freepik.com/free-vector/dad-son-fixing-car-together-white-background_1308-78114.jpg"
            alt="Vehicle Service"
          />
        </div>
